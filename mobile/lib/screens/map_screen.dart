          ...
          ElevatedButton(
            ...
            onPressed: () async {
              if (reasonController.text.isEmpty) {
                 ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Reason is required')));
                 return;
              }
              ...
              try {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Schedule cancelled')));
                Navigator.pop(context, true); // Return true to trigger refresh in HomeScreen
              } catch (e) {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                     ...
                     if (_schedule.contactName != null && _schedule.contactName!.isNotEmpty) ...[
                        SizedBox(height: 4),
                        Row(
                          children: [
                            Icon(Icons.person, size: 16, color: Colors.grey),
                            SizedBox(width: 4),
                            Text(_schedule.contactName!, style: TextStyle(color: Colors.grey[700])),
                            if (_schedule.contactPhone != null && _schedule.contactPhone!.isNotEmpty) ...[
                               SizedBox(width: 8),
                               Icon(Icons.phone, size: 16, color: Colors.grey),
                               SizedBox(width: 4),
                               Text(_schedule.contactPhone!, style: TextStyle(color: Colors.grey[700])),
                            ],
                          ],
                        ),
                     ],
                    ...
                    if (_isLate && _schedule.status != ScheduleStatus.cancel) ...[
                      SizedBox(height: 12),
                      SizedBox(
                           ...
                           onPressed: () async {
                              try {
                                ...
                                await apiService.updateStatus(
                                  ...
                                  cancelReason: null // Clear reason? API might ignore nulls if not explicit.
                                );
                                ...
                                setState(() {
                                  ...
                                  _schedule = Schedule(
                                    ...
                                    status: ScheduleStatus.pending, // Back to pending
                                    transportMode: _schedule.transportMode,
                                    attendeeIds: _schedule.attendeeIds,
                                    cancelReason: _schedule.cancelReason, // Keep reason for history or clear it?
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Schedule restored')));
                              } catch (e) {
